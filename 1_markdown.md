...
1. Making text bold an italic
2. Creating orderd and unordered lists
3. Adding code snippets
4. Creating headers and subheaders

**Importing programming concepts**
...
```
**Useful resources:**
- [Markdown Guide](https://media.githubusercontent.com/media/TUDelft-MUDE/source-files/main/file/markdown_example.png)
...
|:-:            |:-             |:-                         |:-:                |
|Python         |Beginner       |Data Sciene, Web Dev       |⭐⭐⭐⭐⭐     |
